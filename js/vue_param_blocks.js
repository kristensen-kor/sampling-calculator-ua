...
const p_cities_component = {
	...
	data: function() {
		return {
			cities_data: [
				"city_01\tКиїв\tКиїв*\tКиїв\t2906569\ttrue",
				"city_02\tХарків\tХарків*\tХарківська\t1449732\ttrue",
				"city_03\tОдеса\tОдеса*\tОдеська\t1010848\ttrue",
				"city_04\tДніпро\tДніпро*\tДніпропетровська\t983836\ttrue",
				"city_05\tДонецьк\tДонецьк*\tДонецька\t929063\tfalse",
				"city_06\tЗапоріжжя\tЗапоріжжя*\tЗапорізька\t756927\tfalse",
				"city_07\tЛьвів\tЛьвів*\tЛьвівська\t728350\ttrue",
				"city_08\tКривий Ріг\tКривий Ріг\tДніпропетровська\t642333\tfalse",
				"city_09\tМиколаїв\tМиколаїв*\tМиколаївська\t493583\tfalse",
				"city_10\tМаріуполь\tМаріуполь\tДонецька\t453623\tfalse",
				"city_11\tЛуганськ\tЛуганськ*\tЛуганська\t414509\tfalse",
				"city_12\tВінниця\tВінниця*\tВінницька\t373302\tfalse",
				"city_13\tМакіївка\tМакіївка\tДонецька\t347227\tfalse",
				"city_14\tСевастополь\tСевастополь\tАР Крим\t344853\tfalse",
				"city_15\tСімферополь\tСімферополь*\tАР Крим\t338319\tfalse",
				"city_16\tХерсон\tХерсон*\tХерсонська\t294941\tfalse",
				"city_18\tЧернігів\tЧернігів*\tЧернігівська\t294095\tfalse",
				"city_17\tПолтава\tПолтава*\tПолтавська\t294020\tfalse",
				"city_19\tЧеркаси\tЧеркаси*\tЧеркаська\t283356\tfalse",
				"city_22\tХмельницький\tХмельницький*\tХмельницька\t269113\tfalse",
				"city_21\tСуми\tСуми*\tСумська\t267633\tfalse",
				"city_20\tЖитомир\tЖитомир*\tЖитомирська\t267610\tfalse",
				"city_23\tЧернівці\tЧернівці*\tЧернівецька\t266366\tfalse",
				"city_24\tГорлівка\tГорлівка\tДонецька\t249048\tfalse",
				"city_25\tРівне\tРівне*\tРівненська\t248307\tfalse",
				"city_26\tКам'янське\tКам'янське\tДніпропетровська\t239237\tfalse",
				"city_27\tКропивницький\tКропивницький*\tКіровоградська\t231089\tfalse",
				"city_28\tІвано-Франківськ\tІвано-Франківськ*\tІвано-Франківська\t230929\tfalse",
				"city_29\tКременчук\tКременчук\tПолтавська\t223805\tfalse",
				"city_30\tТернопіль\tТернопіль*\tТернопільська\t218228\tfalse",
				"city_31\tЛуцьк\tЛуцьк*\tВолинська\t217450\tfalse",
				"city_32\tБіла Церква\tБіла Церква\tКиївська\t210174\tfalse",
				"city_33\tКраматорськ\tКраматорськ\tДонецька\t159445\tfalse",
				"city_34\tМелітополь\tМелітополь\tЗапорізька\t155899\tfalse",
				"city_35\tКерч\tКерч\tАР Крим\t144626\tfalse",
				"city_36\tУжгород\tУжгород*\tЗакарпатська\t115163\tfalse"
			]
		};
	},
	computed: {
