...
const p_cities_component = {
	...
	mounted: function () {
		const cities_data = [
			"city_01\tКиїв\tКиїв\t2864308\t✓",
			"city_02\tХарків\tХарківська\t1378769\t✓",
			"city_03\tОдеса\tОдеська\t980418\t✓",
			"city_04\tДніпро\tДніпропетровська\t939636\t✓",
			"city_07\tЛьвів\tЛьвівська\t695895\t✓",
			"city_08\tКривий Ріг\tДніпропетровська\t585905\t",
			"city_09\tМиколаїв\tМиколаївська\t456002\t✓",
			"city_12\tВінниця\tВінницька\t358719\t✓",
			"city_18\tЧернігів\tЧернігівська\t274320\t✓",
			"city_17\tПолтава\tПолтавська\t271260\t✓",
			"city_22\tХмельницький\tХмельницька\t266272\t✓",
			"city_19\tЧеркаси\tЧеркаська\t261794\t✓",
			"city_23\tЧернівці\tЧернівецька\t256421\t✓",
			"city_20\tЖитомир\tЖитомирська\t253826\t✓",
			"city_21\tСуми\tСумська\t248830\t✓",
			"city_25\tРівне\tРівненська\t236604\t✓",
			"city_28\tІвано-Франківськ\tІвано-Франківська\t231097\t✓",
			"city_26\tКам'янське\tДніпропетровська\t220084\t",
			"city_30\tТернопіль\tТернопільська\t218298\t✓",
			"city_27\tКропивницький\tКіровоградська\t213129\t✓",
			"city_31\tЛуцьк\tВолинська\t209549\t✓",
			"city_29\tКременчук\tПолтавська\t208855\t",
			"city_32\tБіла Церква\tКиївська\t201095\t",
			"city_06\tЗапоріжжя\tЗапорізька\t170412\t✓",
			"city_36\tУжгород\tЗакарпатська\t112008\t✓",
